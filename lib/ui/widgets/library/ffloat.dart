...
class FFloat extends StatefulWidget {
  ...
  FFloat(
    ...
    this.padding,
    this.color = FFloatContent.defaultColor,
    this.strokeColor,
    this.strokeWidth,
    this.corner,
...
class _FFloat {
  ...
  void _showFloat() {
    ...
    _overlayEntry = OverlayEntry(builder: (BuildContext context) {
      Widget floatContent = FFloatContent(
...
class FFloatContentState extends State<FFloatContent>
  ...
  Widget buildFloatContent() {
    List<Widget> children = [];
    Color color = widget.color ?? FFloatContent.defaultColor;
